...
function gateKeeper(req, res, next) {
   ...
   let parsed = queryString.parse(userInfo) 
 console.log(parsed)
  function arr(users){
    return users.userName == parsed.user & users.password == parsed.pass
  }
  let matchingArr = USERS.find(arr)
  console.log(matchingArr)
  if(matchingArr !== undefined){
    req.user = matchingArr
  }
  next();
}
